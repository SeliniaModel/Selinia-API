...
The Chat API allows you to have natural conversations with Selinia AI assistant powered by GPT-4o.

## Endpoints

### POST /api/chat

Send a message to Selinia and receive a conversational response with context awareness.
...
|-----------|------|----------|-------------|
| message | string | Yes | The user's message to send to Selinia |
...
```json
{
  "response": "I'm Selinia, a friendly and intelligent AI companion created by talented developers who wanted to make AI assistance more personal and friendly. I'm here to help you with various tasks, answer questions, or just have a nice conversation!",
  "usage": {
    "prompt_tokens": 45,
...
|-------|------|-------------|
| response | string | Selinia's response message |
...
Selinia uses the following personality traits:
...
```javascript
const response = await fetch('https://selinia.onrender.com/api/chat', {
  method: 'POST',
